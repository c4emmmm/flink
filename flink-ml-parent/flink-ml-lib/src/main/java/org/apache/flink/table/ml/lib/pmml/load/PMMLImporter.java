 ...
 *
 */
public class PMMLImporter extends Importer<PMMLEvaluateTransformer, String> {

	@Override
	public PMMLEvaluateTransformer load(String pmml) {
		return new PMMLEvaluateTransformer().setPMML(pmml);
	}
